...
public class VBase extends Value {
	...
	public Value mul(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation mul"; return new VError();
	}
	...
	public Value div(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation div"; return new VError();
	}
	...
	public Value add(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation add"; return new VError();
	}
	...
	public Value min(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation min"; return new VError();
	}
	...
	public Value lt(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation lt"; return new VError();
	}
	...
	public Value leq(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation leq"; return new VError();
	}
	...
	public Value gt(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation gt"; return new VError();
	}
	...
	public Value geq(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation geq"; return new VError();
	}
	...
	public Value eq(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation eq"; return new VError();
	}
	...
	public Value neq(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation neq"; return new VError();
	}
	...
	public Value and(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation and"; return new VError();
	}
	...
	public Value or(Value v) {
		assert false : "Wrong types " + this.getClass() + " and " + v.getClass() + " in operation or"; return new VError();
	}
	...
	@Override
	public Value not() {
		assert false : "Wrong type " + this.getClass() + " in operation not"; return new VError();
	}
